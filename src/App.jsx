          ...
          {activities.length > 0 && (
            <div className="flex justify-center space-x-2 mt-6 mb-8">
              <button
                ...
                className={`px-6 py-2 rounded-lg font-semibold transition-all ${viewMode === 'grid'
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg font-semibold transition-all ${viewMode === 'calendar'
                    ? 'bg-blue-500 text-white'
                    : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                  }`}
              >
